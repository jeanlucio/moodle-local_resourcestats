...
- Tracks total and unique views per course module
- Badges displayed below each resource on the course page (teachers only)
- Per-user display mode preference (total, unique, both, none)
- Dedicated statistics page per module
